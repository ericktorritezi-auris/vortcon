        ...
        {tenants.map((tenant: TenantWithOwner) => {
          ...
          return (
            <Link
              ...
              className="border-ink-secondary/15 flex flex-col gap-2 rounded-lg border bg-surface-card p-4 hover:border-brand-flow sm:flex-row sm:items-center sm:justify-between"
            >

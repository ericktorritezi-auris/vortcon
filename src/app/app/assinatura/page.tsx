...
export default async function MySubscriptionPage(): Promise<React.ReactElement> {
  ...
  return (
    <AppShell>
      ...
      {subscription ? (
        <div className="border-ink-secondary/15 mb-6 rounded-lg border bg-surface-card p-5">
      ...
      <div className="divide-ink-secondary/10 border-ink-secondary/15 flex flex-col divide-y rounded-lg border bg-surface-card px-4">
